...
// import mx from "../../assets/cards/mx.svg";
// import paypal from "../../assets/cards/paypal.svg";
// import diner from "../../assets/cards/dinersclub.svg";
...
//             </svg>
//           </div>
//           <div className="w-[22%] flex flex-col gap-9">
//             <div className=" flex flex-col gap-5">
//               <h6 className="font-bold text-lg">Customer Care</h6>
//               <div className="text-sm text-richblack-700 flex flex-col gap-3">
//                 <p>(800) 8001-8588</p>
//                 <p>Hours of Operation</p>
//                 <p className="font-bold">Monday - Friday 5:30am- 5:00pm</p>
//                 <p className="font-bold">Pacific Standard Time</p>
//               </div>
//             </div>
//             <div className="flex flex-col gap-5">
//               <h6 className="font-bold text-lg">Contact Us</h6>
//               <div className="text-sm transition-all duration-200 flex flex-col gap-3">
//                 {["Technical Support", "Online Order Support"].map(
//                   (element, index) => (
//                     <Link
//                       key={index}
...
//           <p className="text-sm">
//             © 2025 <span className="font-bold">Arena Electro XII.</span> All
//             Rights Reserved
//           </p>
    ...
    <div className="bg-pure-greys-5 text-richblack-800">
      <div className="mx-auto w-11/12 max-w-maxContent flex flex-col">
        <div className="flex flex-col md:flex-row py-16">
          <div className="w-full md:w-[34%] mb-8 md:mb-0">
            <svg
              version="1.1"
              x="0px"
              y="0px"
          ...
          <div className="w-full md:w-[22%] mb-8 md:mb-0">
            <div className="flex flex-col gap-9">
              <div className="flex flex-col gap-5">
                ...
                <div
                  className={`text-sm text-richblack-700 flex flex-col gap-3 ${
              ...
              <div className="flex flex-col gap-5">
                ...
                <div
                  className={`text-sm transition-all duration-200 flex flex-col gap-3 ${
                    openSection === "contactUs" || window.innerWidth >= 768
                      ? "block"
                      : "hidden"
                  }`}
                >
          ...
          <div className="w-full md:w-[22%] mb-8 md:mb-0">
            <div className="flex flex-col gap-5">
              ...
              <div
                className={`text-sm transition-all duration-200 flex flex-col gap-3 ${
                  openSection === "help" || window.innerWidth >= 768
                    ? "block"
                    : "hidden"
                }`}
              >
          ...
          <div className="w-full md:w-[22%]">
            <div className="flex flex-col gap-5">
              ...
              <div
                className={`text-sm transition-all duration-200 flex flex-col gap-3 ${
                  openSection === "aboutUs" || window.innerWidth >= 768
                    ? "block"
                    : "hidden"
                }`}
              >
